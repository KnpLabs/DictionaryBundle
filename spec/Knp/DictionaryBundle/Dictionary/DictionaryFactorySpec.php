...
class DictionaryFactorySpec extends ObjectBehavior
{
    ...
    public function it_doesnt_call_transformers_transform_method_if_not_supported(
        $transformer
    ) {
    ...
    public function it_calls_transformers_transform_method_if_supported(
        $transformer
    ) {
        $transformer->supports('bar')->shouldBeCalled();
    ...
    public function it_doesnt_call_transformers_transform_method_for_specific_dictionaries(
        $transformer
    ) {
        $transformer->supports('baz')->shouldBeCalled();
